    ...
    return (
        <div>
            <button
                ...
                className="block w-[40%] h-[30px] rounded mx-auto  bg-[#00BF62] text-white font-medium text-center " type="button">
                اختبر الآن
            </button>
            ...
            <div id="default-modal"
                tabIndex="-1"
                aria-hidden="true"
                className={`fixed inset-0 z-50  items-center justify-center w-full ${isopen ? 'flex' : 'hidden'}`}>
